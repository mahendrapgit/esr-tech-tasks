...
<script src="https://js.pusher.com/7.0/pusher.min.js"></script>
  <script>
    ...
    channel.bind("{{ Config::get('broadcasting.event_as.employee_added') }}", function(data) {
      alert(data.text);
    });
  </script>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <div class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <a class="" href="{{ url('/companies') }}">Companies</a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="" href="{{ url('/employees') }}">Employees</a>
                                </li>
                            </div>
